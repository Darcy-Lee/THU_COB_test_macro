def format_strings(input_filepath, output_filepath, max_strings_per_line=12):
    try:
        # 读取输入文件
...
# 示例用法
input_filepath = 'Pagedata\\result4_resolved.txt'  # 输入文件路径
output_filepath = 'Pagedata\\result4_resolved_12.txt'  # 输出文件路径
